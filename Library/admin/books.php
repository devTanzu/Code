<?php
include "connection.php"; // Ensure connection is included and $conn is available
...
if (isset($_POST['submit'])) {
    $search = mysqli_real_escape_string($db, $_POST['search']);  // Use $conn here
    $q = mysqli_query($db, "SELECT * FROM books WHERE b_name LIKE '%$search%'");  // Use $conn here
    ...
    $result = mysqli_query($db, $query);  // Use $conn here
